...
class SecondFragment : Fragment(R.layout.fragment_second), DogClickListener {
    ...
    private lateinit var bindingFragmentSecond: FragmentSecondBinding
    private val dogAdapter = DogAdapter(this)
    private val dogList: List<Dog> = getMockDogList()

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        bindingFragmentSecond = FragmentSecondBinding.bind(view)
        val recyclerView: RecyclerView = bindingFragmentSecond.dogList
